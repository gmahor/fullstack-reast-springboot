      ...
      <div className="max-w-5xl w-full mx-auto flex flex-col md:flex-row md:space-x-8 px-6 p-8">
        ...
        <div className="w-full md:w-1/2 flex flex-col space-y-6 mt-8 md:mt-0">
          ...
          <div className="flex flex-col space-y-4">
            ...
            {/* Add to Cart Button */}
            <button className="w-full px-4 py-2 my-2 bg-primary dark:bg-light text-white dark:text-black rounded-md text-lg font-semibold hover:bg-dark dark:hover:bg-lighter transition">
              Add to Cart
